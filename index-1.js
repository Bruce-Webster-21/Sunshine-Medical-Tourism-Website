...
function sendEmail() {
  Email.send({
    ...
    Body : "<br> <b> Patient wants the 200$ PACKAGE</b>"
    + "<br> <br>"
    + "<hr>"
    ...
    + "<b>Patient wants:</b><br>   " + plasticSurgeryYesNo() + dentalWorkYesNo() + bariatricYesNo() + microbladingYesNo() + vaginoplastyYesNo() + other1YesNo() + "<br>" + document.getElementById("other-service-input").value
    + "<br> <b>Kind of Plastic Surgery:</b><br>   " + liposuctionYesNo() + bblYesNo() + tummyTuckYesNo() + breastAugmentationYesNo() + breastReductionYesNo() + breastImplantRevisionYesNo() + breastLiftYesNo() + armLiftYesNo() + thighLiftYesNo() + rhinoplastyYesNo()
    + "<br>"
    + "<hr>"
    ...
    + "<b>Patient's Medical conditions:</b><br>   " + diabetesYesNo() + highBloodPressureYesNo() + highCholesterolYesNo() + thalassemiaYesNo() + heartAttackYesNo() + heartFailureYesNo() + chestPainYesNo() + anginaYesNo() + cancerYesNo() + LupusYesNo() + AsthmaYesNo() + sleepApneaYesNo() + arthritisYesNo() + jointPainBackPainYesNo() + gerdHeartburnYesNo() + ulcersYesNo() + liverDiseaseYesNo() + frequentDiarrheasYesNo() + crohnsDiseaseColitisYesNo()  + bladderIncontinenceYesNo() + hivYesNo() + hepatitisYesNo() + sicklemiaYesNo() + sickleCellTraitYesNo() + thyroidYesNo() + multipleSclerosisYesNo() + leukemiaYesNo() + syphilisYesNo() + myastheniaGravisYesNo() + coronavirusYesNo() + noneYesNo()
    + "<br>"
    + "<hr>"
...
//-------------------------------------------------------------------------------------------------------
// INDEX.HTML INTERACTIVITY
//------------------------------------------------------------------------------------------------------- 

function translateEsp() {
  espTxt = document.getElementById("contact-us-btn-esp")
  engTxt = document.getElementById("contact-us-btn")

  espTxt.style.display = "block"
